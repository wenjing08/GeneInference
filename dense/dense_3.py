...
class dense_3(nn.Module):
    def __init__(self):
        ...
        self.layer2 = nn.Sequential(
            nn.Linear(in_size + n_hidden, n_hidden),
            nn.Dropout(dropout_rate),
            nn.ReLU())
        self.layer3 = nn.Sequential(
            nn.Linear(in_size + n_hidden + n_hidden, n_hidden),
            nn.Dropout(dropout_rate),
            nn.ReLU())
        self.layer4 = nn.Sequential(
            nn.Linear(in_size + n_hidden + n_hidden + n_hidden, out_size))
...
outlog = open('../res/dense/dense3-'+file_num+'.log', 'w')
...
np.save('../res/dense/dense3-'+file_num+'.npy', te_outputs_best)
