...
net_0.load_state_dict(torch.load("../res/external_res/first_half3000_3/model_params_2.pt"))
...
net_1.load_state_dict(torch.load("../res/external_res/first_half3000_3/model_params_3.pt"))
...
net_2.load_state_dict(torch.load("../res/external_res/first_half3000_3/model_params_4.pt"))
